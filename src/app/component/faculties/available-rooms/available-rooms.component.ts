...
import {ClassRoom} from "../../../dto/class.room";
    ...
    this.routineService.getClassRoomDateAndTime().subscribe(res => {
      ...
      res.days.forEach(dayWise => {
        ...
        dayWise.saturday.forEach(day => {
          if (day.roomNo === 'AB4-514' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
          ...
          if (day.roomNo === 'AB4-204' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
          ...
          if (day.roomNo === 'AB4-503' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
          ...
          if (day.roomNo === 'AB4-602' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
          ...
          if (day.roomNo === 'AB4-604' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
          ...
          if (day.roomNo === 'AB1-103' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
          ...
          if (day.roomNo === 'AB4-220' && day.courseCode === 'Not Occupied') {
            var timesOfClass = {
              startTime: day.startTime,
              endTime: day.endTime
            };
